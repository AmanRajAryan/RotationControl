...
public class MainActivity extends Activity {
    ...
    private void checkAndRequestPermissions() {
        ...
        // All permissions granted, apply rotation
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == REQUEST_NOTIFICATION_PERMISSION) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(this, "Notification permission denied. You won't see the persistent notification.", Toast.LENGTH_LONG).show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_OVERLAY_PERMISSION) {
            ...
            if (checkWriteSettingsPermission()) {
                ...
                checkAndRequestPermissions(); // Continue or apply
            } else {
    ...
    private void applyRotationSetting() {
        ...
        if (selectedId == R.id.radioAuto) {
            ...
            // Start the rotation lock service
            Intent serviceIntent = new Intent(this, RotationLockService.class);
            ...
            Toast.makeText(this, "Rotation locked to " + rotationName + "\nService running in background", Toast.LENGTH_LONG).show();
        }
    }
